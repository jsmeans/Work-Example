<?php if( have_rows('options') ): ?>
    ...
    <div class="rates mortgages">
      ...
      <div class="rate-block" >
        ...
        <h3 class="card-term">Minimum Deposit</h3>
      ...
      <?php while ( have_rows('options') ) : the_row(); 
        ...
        $minimum = $rateChoice['minimum_deposit'];
        $APR = $rateChoice['apy'];
      ...
      ?>
          ...
          <div class="rate-block" >
            ...
            <p class="card-term">$<?php echo $minimum ?></p>
      ...
      <div class="disclaimer">
        ...
        <?php $disclaimer = get_field( 'certificates_disclaimer' , 'option');
